...
<br><br><br>
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div>
                 <h1 style=" color:rgb(112,128,144); font-size:60px;" class="lead" ><u>Transfer Money</u></h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <br><button type="submit" class="btn btn-outline-light">Transfer</button><br><br>
                    <p style="color:white;" class="lead">Want to check your balance? check <a href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
